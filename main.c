...
#pragma config(Motor,  port6,           DriveBLA,      tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port7,           DriveBRA,      tmotorVex393TurboSpeed_MC29, openLoop, reversed)
